...
*/
#ifndef NS3NAMENODE_H
#define NS3NAMENODE_H
...
class NameNodeServer: public Application {
public:
...
class NameNodeClient: public Application {
public:
    static TypeId GetTypeId(void);
    NameNodeClient();
...
class NameNodeServerHelper {
public:
    NameNodeServerHelper(uint16_t port);
    /**
...
class NameNodeClientHelper {
public:
    NameNodeClientHelper(Ipv4Address ip, uint16_t port);
    /**
    ...
    Ptr<NameNodeClient> GetClient(void);
private:
    Ptr<Application> InstallPriv(Ptr<Node> node);
    ObjectFactory m_factory;
    Ptr<NameNodeClient> m_client;
};
